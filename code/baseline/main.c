...
int main(int argc, char *argv[])
{
    ...
    image* train_img = read_images("/home/sachab/Documents/Centrale/INFOIA/GPGPU/MNIST/train-images.idx3-ubyte", &datasize);
    byte* train_label = read_labels("/home/sachab/Documents/Centrale/INFOIA/GPGPU/MNIST/train-labels.idx1-ubyte", &datasize);
    image* test_img = read_images("/home/sachab/Documents/Centrale/INFOIA/GPGPU/MNIST/t10k-images.idx3-ubyte", &ntest);
    byte* test_label = read_labels("/home/sachab/Documents/Centrale/INFOIA/GPGPU/MNIST/t10k-labels.idx1-ubyte", &ntest);
